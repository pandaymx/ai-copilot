...
class AugmentedToolCallbackTest {
    ...
    void testToolEventEmitterMergesInnerThought() {
        ...
        emitter.executeWithEvent(
                "http_request", "{\"url\":\"https://example.com\"}", toolContext, () -> "{\"status\":200}");
    ...
    void testWrapToolsWithMcpOption() {
        ...
        ToolDefinition localDef = ToolDefinition.builder()
                .name("local")
                .description("local")
                .inputSchema("{}")
                .build();
        ...
        // augmentMcp = false
        ToolCallback[] mergedWithoutMcp =
                provider.wrapTools(new ToolCallback[] {local}, new ToolCallback[] {mcp}, false);
