...
class DocumentReaderFactoryTest {
    ...
    void metadataEnricher_shouldPreservePageNumberAsString() {
        ...
        Document pdfDoc = new Document("pdf-1", "PDF page content",
                Map.of("pageNumber", "3")); // String
        ...
        assertThat(enriched.getMetadata().get("pageNumber")).isInstanceOf(String.class).isEqualTo("3");
    ...
    void metadataEnricher_shouldSetTitleAndUrlWhenProvided() {
        ...
        RagMetadataEnricher.enrich(docs, "URL",
                "https://example.com/article",
                "", "https://example.com/article",
                "Example Article Title", "user-url");
