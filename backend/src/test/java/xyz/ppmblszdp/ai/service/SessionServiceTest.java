...
class SessionServiceTest {
    ...
    void testGetSessionDetailConstructsMessages() {
        ...
        when(chatMemory.get("conv-1"))
                .thenReturn(List.of(
                        new SystemMessage("System prompt"), new UserMessage("Hi"), new AssistantMessage("Hello")));
    ...
    void testRenameSessionExisting() {
        when(sessionRepository.findByIdAndUserId("conv-1", "user-1"))
                .thenReturn(Optional.of(new SessionDto("conv-1", "Old Title", 1000L, false)));
