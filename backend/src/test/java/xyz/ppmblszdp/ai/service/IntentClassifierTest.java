...
class IntentClassifierTest {
	...
	void testSlashCommandsShortCircuit() {
		...
		ChatRequest transReq = new ChatRequest("/translate hello world", null, null, null, null, null, null, null, null);
	...
	void testMultimodalShortCircuit() {
		MediaDto media = new MediaDto("image/png", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==");
	...
	void testPatternMatchCode() {
		ChatRequest req1 = new ChatRequest("public class Main { public static void main(String[] args) {} }", null, null, null, null, null, null, null, null);
