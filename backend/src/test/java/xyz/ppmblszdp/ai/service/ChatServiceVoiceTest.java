...
class ChatServiceVoiceTest {
    ...
    private AiProviderProperties mockProperties() {
        ...
        when(properties.resolveMemory()).thenReturn(AiProviderProperties.MemoryConfig.defaults());
        when(properties.resolveAgent()).thenReturn(AiProviderProperties.AgentConfig.defaults());
        return properties;
    }
    ...
    private ChatService minimalService(OpenAiAudioSpeechModel speech) {
        ...
        return new ChatService(
                ...
                mockProperties(),
                provider,
                new ToolEventEmitter(mockProperties()),
                null,
                null,
                null);
    }
    ...
    void synthesizeSpeechReturnsAudio() {
        ...
        when(speech.call(any(TextToSpeechPrompt.class))).thenReturn(new TextToSpeechResponse(java.util.List.of(sp)));
    ...
    void synthesizeSpeechThrowsWhenModelMissing() {
        ...
        ChatService svc = new ChatService(
                ...
                null,
                null);
        assertThrows(IllegalStateException.class, () -> svc.synthesizeSpeech("hi", null, "u1")
                .block());
    }
    ...
    void transcribeAudioRejectsEmpty() {
        ...
        assertThrows(IllegalArgumentException.class, () -> svc.transcribeAudio(new byte[0], "audio/webm", "u1")
                .block());
    }
    ...
    void transcribeAudioReturnsTextViaGeminiMultimodal() {
        ...
        when(chatModel.call(any(Prompt.class)))
                .thenReturn(new ChatResponse(java.util.List.of(new Generation(new AssistantMessage("转录文本")))));
