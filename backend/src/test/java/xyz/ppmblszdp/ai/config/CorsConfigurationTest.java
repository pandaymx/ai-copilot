...
class CorsConfigurationTest {
    ...
    void corsWebFilter_WildcardOriginAndNoCredentials_ReturnsExactWildcardOriginHeader() {
        ...
        MockServerWebExchange exchange =
                MockServerWebExchange.from(MockServerHttpRequest.options("http://localhost:8084/api/chat")
    ...
    void corsWebFilter_ActualGetRequest_ReturnsCorsHeader() {
        ...
        MockServerWebExchange exchange =
                MockServerWebExchange.from(MockServerHttpRequest.get("http://localhost:8084/api/chat")
                        .header("Origin", "http://example.com")
                        .build());
    ...
    void corsWebFilter_WithStrictModeAndWildcard_ConstructsSuccessfullyWithWarning() {
        CorsProperties corsProperties = new CorsProperties("*", false, "*");
        AuthProperties strictAuth = new AuthProperties("strict", "X-User-Id", java.util.Set.of("admin"));
        AiBeansConfiguration beansConfig = new AiBeansConfiguration();
    ...
    void hostValidationWebFilter_ValidHost_AllowsChainExecution() {
        ...
        MockServerWebExchange exchange =
                MockServerWebExchange.from(MockServerHttpRequest.get("http://localhost:3000/api/chat")
        ...
        StepVerifier.create(hostFilter.filter(exchange, filterChain)).verifyComplete();
    ...
    void hostValidationWebFilter_InvalidRebindingHost_ReturnsForbidden() {
        ...
        MockServerWebExchange exchange =
                MockServerWebExchange.from(MockServerHttpRequest.get("http://attacker.com/api/chat")
