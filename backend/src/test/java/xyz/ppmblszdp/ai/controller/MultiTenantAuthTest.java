...
class MultiTenantAuthTest {
    ...
    void strictModeMissingHeaderReturns401() {
        ResponseStatusException ex = Assertions.assertThrows(
                ResponseStatusException.class, () -> sessionController.getSessions(exchangeWithoutHeader()));
    ...
    void titleEndpointCrossUserReturns404() {
        ...
        StepVerifier.create(chatController.title(req, exchangeWithUser("alice")))
                .expectErrorMatches(
                        t -> t instanceof ResponseStatusException ex && ex.getStatusCode() == HttpStatus.NOT_FOUND)
                .verify();
    }
