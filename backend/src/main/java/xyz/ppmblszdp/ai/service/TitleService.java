...
public class TitleService {
	...
	private static final Pattern FILLER_PREFIX_PATTERN =
			Pattern.compile("^\\s*(请问|如何|怎么|请帮我|帮我|我想|关于|请分析|请写一个|编写一个|写一个|设计一个|对比分析|分析|解析)\\s*", Pattern.CASE_INSENSITIVE);
