...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "fixed inset-y-0 left-0 z-30 flex w-72 flex-col border-r border-zinc-200/70 bg-zinc-50/70 backdrop-blur-xl transition-all duration-300 dark:border-zinc-800/80 dark:bg-zinc-950/80",
      ...
      <div className="flex flex-col gap-3 border-b border-zinc-200/60 p-3.5 dark:border-zinc-800/60">
        <div className="flex items-center justify-between px-1">
          ...
          <Button
            variant="ghost"
            size="icon-sm"
            className="text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white md:hidden"
